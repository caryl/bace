#--
# BaceScaffoldGeneratorConfig based on rubygems code.
# Thank you Chad Fowler, Rich Kilmer, Jim Weirich and others.
#++
class BaceScaffoldGeneratorConfig
  ...
  def config_file
     File.join(find_home, '.bace_generator')
  end
...
class BaceScaffoldGenerator < Rails::Generator::NamedBase
  ...
  def initialize(runtime_args, runtime_options = {})
    ...
    @configuration = BaceScaffoldGeneratorConfig.new
  ...
  def manifest
    record do |m|
      ...
      m.dependency 'bace_model', [name] + @args, :collision => :skip
    end
  end
